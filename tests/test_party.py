...
class TestParty:
    def test_add_parties_votes(self, parties_with_representatives: list[Party]):
    ...
    def test_add_parties_representatives(self, parties_with_representatives: list[Party]):
        """Checks that + operator works. Votes and representatives should be added together."""
        party_a, party_b = parties_with_representatives
        added_parties = party_a + party_b
